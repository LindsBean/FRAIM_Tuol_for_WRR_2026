...
Today <- Sys.Date()
  ...
  # get raw data ID:
  flowdat <- contentid::store(glue("data_raw/fnf_daily_dwr_{siteID}_downloaded_cdec_{Today}.csv"))
  ...
  # write out
  readr::write_csv(clean_df_timing, glue("data_clean/clean_fnf_daily_dwr_{siteID}_cdec_{Today}.csv"))
  
  # print message!
  print(glue("Daily data saved here: 'data_clean/clean_fnf_daily_dwr_{siteID}_cdec_{Today}.csv'"))
  
  # write out
  readr::write_csv(all_ann_stats, glue("data_clean/clean_fnf_ann_stats_{siteID}_cdec_{Today}.csv"))
  
  # print message!
  print(glue("Annual data saved here: 'data_clean/clean_fnf_daily_dwr_{siteID}_cdec{Today}.csv'"))
