...
Today <- Sys.Date()
  ...
  flowdat <- get_cdec(siteID, sensor, "D", start="1986-04-01", end="2023-02-01") %>% 
  ...
  # write out
  write_csv(flowdat, file=glue("data_raw/fnf_daily_dwr_{siteID}_downloaded_cdec_{Today}.csv"))
